...
const Addpat = () => {
    ...
    return (
        ...
        >
            ...
            >
            <h4 className="my-4 text-center fw-bold text-dark fs-1">ADD PATIENT</h4>
            ...
            <div className="container d-flex justify-content-center align-items-center">
                ...
                <h5 className="text-center fw-bold mb-4">Patient Registration</h5>
